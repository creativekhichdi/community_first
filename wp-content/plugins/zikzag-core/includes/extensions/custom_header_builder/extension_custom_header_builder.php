        ...
        private function is_minimum_version () {
            ...
            if ($this->min_redux_version != '') {
                if (version_compare($redux_ver, $this->min_redux_version) < 0) {
                    $msg = '<strong>' . esc_html__( 'The', 'zikzag-core') . ' ' .  $this->ext_name . ' ' .  esc_html__('extension requires', 'zikzag-core') . ' Redux Framework ' . esc_html__('version', 'zikzag-core') . ' ' . $this->min_redux_version . ' ' .  esc_html__('or higher.','zikzag-core' ) . '</strong>&nbsp;&nbsp;' . esc_html__( 'You are currently running', 'zikzag-core') . ' Redux Framework ' . esc_html__('version','zikzag-core' ) . ' ' . $redux_ver . '.<br/><br/>' . esc_html__('This field will not render in your option panel, and featuress of this extension will not be available until the latest version of','zikzag-core' ) . ' Redux Framework ' . esc_html__('has been installed.','zikzag-core' );
