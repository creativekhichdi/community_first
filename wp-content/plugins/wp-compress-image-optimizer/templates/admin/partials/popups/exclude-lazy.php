<div id="exclude-lazy-popup" style="display: none;">
            ...
            <form method="post" class="wpc-save-popup-data" action="#">
                <div class="cdn-popup-content-full">
                    <div class="cdn-popup-content-inner">
                      ...
                      if ( ! empty($excludes['lazy'])) {
                        $excludes['lazy'] = implode("\n", $excludes['lazy']);
                      } else {
	                      $excludes['lazy'] = '';
                      }

                      ?>
                        <textarea name="wpc-excludes[lazy]" data-setting-name="wpc-excludes"
                                  data-setting-subset="lazy"  class="exclude-list-textarea-value"
                                  placeholder="e.g. plugin-name/js/script.js, scripts.js, anyimage.jpg"><?php echo
                          $excludes['lazy']; ?></textarea>
