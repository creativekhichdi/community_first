    ...
    <form method="post" class="wpc-save-popup-data" action="#">
      <div class="cdn-popup-content-full">
        <div class="cdn-popup-content-inner">
          ...
          if ( ! empty($excludes['advanced_caching'])) {
            $excludes['advanced_caching'] = implode("\n", $excludes['advanced_caching']);
          } else {
	          $excludes['advanced_caching'] = '';
          }
          
          ?>
          <textarea name="wpc-excludes[advanced_caching]" data-setting-name="wpc-excludes" data-setting-subset="advanced_caching" class="exclude-list-textarea-value" placeholder="e.g. plugin-name/js/script.js, scripts.js, anyimage.jpg"><?php echo $excludes['advanced_caching']; ?></textarea>
