<div id="exclude-critical-css" style="display: none;">
    ...
    <form method="post" class="wpc-save-popup-data" action="#">
      <div class="cdn-popup-content-full">
        <div class="cdn-popup-content-inner">
          ...
          if ( ! empty($excludes['critical_css'])) {
            $excludes['critical_css'] = implode("\n", $excludes['critical_css']);
          } else {
	          $excludes['critical_css'] = '';
          }
          
          ?>
          <textarea name="wpc-excludes[critical_css]" data-setting-name="wpc-excludes" data-setting-subset="critical_css"  class="exclude-list-textarea-value" placeholder="e.g. plugin-name/js/script.js, scripts.js, anyimage.jpg"><?php echo $excludes['critical_css']; ?></textarea>
