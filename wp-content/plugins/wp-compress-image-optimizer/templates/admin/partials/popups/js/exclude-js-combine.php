<div id="exclude-js-combine" style="display: none;">
    ...
    <form method="post" class="wpc-save-popup-data" action="#">
      <div class="cdn-popup-content-full">
        <div class="cdn-popup-content-inner">
          ...
          if ( ! empty($excludes['combine_js'])) {
            $excludes['combine_js'] = implode("\n", $excludes['combine_js']);
          } else {
	          $excludes['combine_js'] = '';
          }
          
          ?>
          <textarea name="wpc-excludes[combine_js]" data-setting-name="wpc-excludes" data-setting-subset="combine_js" class="exclude-list-textarea-value" placeholder="e.g. plugin-name/js/script.js, scripts.js, anyimage.jpg"><?php echo $excludes['combine_js']; ?></textarea>
