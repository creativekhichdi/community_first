    ...
    <div class="wp-compress-settings-row wps-ic-live-compress wpc-ic-mu-settings" style="margin-top:0px;">
      <div class="text-center" style="width: 100%;display: flex;">
        ...
        <div class="inner">
          ...
          <div class="checkbox-container-v2 informative-input ic-tooltip" title="Intelligently show retina enabled images based on device, which can improve the image quality on retina enabled devices.">
        ...
        <div class="inner">
          ...
          <div class="checkbox-container-v2 informative-input ic-tooltip" title="Load your images only when they are in viewport.">
        ...
        <div class="settings-container-half settings-container-left first">
          <div class="inner">
            ...
            <div style="margin-left:15px;display:flex;width:100%;">
              <div class="setting-body-half settings-area-serve-cdn settings-area-serve-cdn-images">
                <div class="setting-inner-header">
                  <h3>Serve Images</h3>
                </div>
								<?php
								if (empty($settings['live-cdn']) || $settings['live-cdn'] == 'local') {
									?>
                  <div class="setting-option wpc-checkbox">
                    <input type="checkbox" id="serve_jpg" value="1" name="wp-ic-setting[serve_jpg]" data-setting_name="serve_jpg" data-setting_value="1" class="disabled-checkbox ic-tooltip" title="Switch to live optimization to serve images."/>
                    <label for="serve_jpg">JPG/JPEG</label>
                  </div>
                  <div class="setting-option wpc-checkbox">
                    <input type="checkbox" id="serve_png" value="1" name="wp-ic-setting[serve_png]" data-setting_name="serve_png" data-setting_value="1" class="disabled-checkbox ic-tooltip" title="Switch to live optimization to serve images."/>
                    <label for="serve_png">PNG</label>
                  </div>
                  <div class="setting-option wpc-checkbox">
                    <input type="checkbox" id="serve_gif" value="1" name="wp-ic-setting[serve_gif]" data-setting_name="serve_gif" data-setting_value="1" class="disabled-checkbox ic-tooltip" title="Switch to live optimization to serve images."/>
                    <label for="serve_gif">GIF</label>
                  </div>
                  <div class="setting-option wpc-checkbox">
                    <input type="checkbox" id="serve_svg" value="1" name="wp-ic-setting[serve_svg]" data-setting_name="serve_svg" data-setting_value="1" class="disabled-checkbox ic-tooltip" title="Switch to live optimization to serve images."/>
                    <label for="serve_svg">SVG</label>
                  </div>
								<?php } else { ?>
                  <div class="setting-option wpc-checkbox">
                    <input type="checkbox" id="serve_jpg" value="1" name="wp-ic-setting[serve_jpg]" data-setting_name="serve_jpg" data-setting_value="1" <?php echo checked($settings['serve_jpg'], '1'); ?> title="Switch to live optimization to serve images."/>
                    <label for="serve_jpg">JPG/JPEG</label>
                  </div>
                  <div class="setting-option wpc-checkbox">
                    <input type="checkbox" id="serve_png" value="1" name="wp-ic-setting[serve_png]" data-setting_name="serve_png" data-setting_value="1" <?php echo checked($settings['serve_png'], '1'); ?> title="Switch to live optimization to serve images."/>
                    <label for="serve_png">PNG</label>
                  </div>
                  <div class="setting-option wpc-checkbox">
                    <input type="checkbox" id="serve_gif" value="1" name="wp-ic-setting[serve_gif]" data-setting_name="serve_gif" data-setting_value="1" <?php echo checked($settings['serve_gif'], '1'); ?> title="Switch to live optimization to serve images."/>
                    <label for="serve_gif">GIF</label>
                  </div>
                  <div class="setting-option wpc-checkbox">
                    <input type="checkbox" id="serve_svg" value="1" name="wp-ic-setting[serve_svg]" data-setting_name="serve_svg" data-setting_value="1" <?php echo checked($settings['serve_svg'], '1'); ?> title="Switch to live optimization to serve images."/>
                    <label for="serve_svg">SVG</label>
                  </div>
								<?php } ?>
              </div>
