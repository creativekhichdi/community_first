...
define('WPC_IC_CACHE_EXPIRE', 60 * 30); // 30 Minutes

// Local API
define('WPS_IC_LOCAL_API', 'https://germany.zapwp.net/local/v3/index.php');
...
// DEV URL
#define('WPS_IC_CRITICAL_API_URL', 'https://critical-api.pingwp.com/index-dev.php');
// Real URL
define('WPS_IC_CRITICAL_API_URL', 'https://critical-api.pingwp.com/index.php');
define('WPS_IC_CRITICAL_API_ASSETS_URL', 'https://critical-api.pingwp.com/assets.php');
...
define('WPS_IC_CRITICAL', WP_CONTENT_DIR . '/cache/wp-cio-critical/');
define('WPS_IC_CRITICAL_URL', WP_CONTENT_URL . '/cache/wp-cio-critical/');
